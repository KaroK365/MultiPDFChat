...
def get_conversational_chain(model_name, vectorstore=None, api_key=None):
    if model_name == "Google AI":
        prompt_template = """
        Answer the question as detailed as possible from the provided context, make sure to provide all the details, if the answer is not in provided context just say, "answer is not available in the context", and try to give what the answer could be do mention the answer can be wrong and was not mentioned in the PDF\n\n
        Context:\n {context}?\n
        Question: \n{question}\n
    ...
    if model_name == "Google AI":
        ...
        st.markdown(
            ...
            <div class="chat-message user">
                <div class="avatar">
                    <img src="https://i.ibb.co/Hf30pnmg/vecteezy-avatar-man-icon-cartoon-male-profile-mascot-vector-9749751.jpg" alt="vecteezy-avatar-man-icon-cartoon-male-profile-mascot-vector-9749751" border="0">
                </div>    
                <div class="message">{user_question_output}</div>
            </div>
            <div class="chat-message bot">
                <div class="avatar">
                   <img src="https://i.ibb.co/WQ07LM6/vecteezy-ai-robot-icon-illustration-52060363.jpg" alt="vecteezy-ai-robot-icon-illustration-52060363" border="0">
                </div>
...
def main():
    st.set_page_config(page_title="MultiPDF Chatbot", page_icon="💬📁")
    st.header("💬📁 ChatBot 💬📁")

    if 'conversation_history' not in st.session_state:
        st.session_state.conversation_history = []
    linkedin_profile_link = "https://www.linkedin.com/in/as365/"
    github_profile_link = "https://github.com/Karok365/"
